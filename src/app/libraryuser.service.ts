...
export class LibraryuserService {
 private baseURL="http://localhost:8081/allusers";
 private baseURL1="http://localhost:8081/deleteUser";
 private baseURL2=  "http://localhost:8081/userById";
 private baseURL3=  "http://localhost:8081/updateUser";
 private baseURL4="http://localhost:8081/userByName";
 private baseURL5="http://localhost:8081/addusers";
